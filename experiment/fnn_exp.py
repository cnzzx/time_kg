...
# prepare model
model = FNN_Model(input_size=input_size, hidden_size=hidden_size, num_layers=num_layers, input_step_len=input_step_len, output_step_len=output_step_len)
